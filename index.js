...
app.use((req, res, next) => {
  res.setHeader('Access-Control-Allow-Origin', 'https://students-e6b4bp5uq-itsaniket1s-projects.vercel.app');
...
const corsOptions = {
  origin:' https://students-e6b4bp5uq-itsaniket1s-projects.vercel.app', // Replace with your frontend origin
