...
app.use((req, res, next) => {
  res.setHeader('Access-Control-Allow-Origin', 'https://students-1t5pcpy9p-itsaniket1s-projects.vercel.app');
...
const corsOptions = {
  origin:' https://students-1t5pcpy9p-itsaniket1s-projects.vercel.app', // Replace with your frontend origin
